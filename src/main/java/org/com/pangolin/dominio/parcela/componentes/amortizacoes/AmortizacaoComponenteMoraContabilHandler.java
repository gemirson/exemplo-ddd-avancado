...
public class AmortizacaoComponenteMoraContabilHandler implements  IComponenteAmortizacaoHandler{

    private static  final Set<TipoComponente> COMP0NENTES_CUSTO = Set.of(
            TipoComponente.MORA_CONTABIL,
            TipoComponente.MORA_JUDICIAL,
            TipoComponente.MORA_CONTRATUAL
    );
